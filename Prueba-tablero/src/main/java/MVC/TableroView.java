...
public class TableroView extends JFrame {
    ...
    private LogicaPozo logicaPozo; // Instancia de LogicaPozo
    ...
    public TableroView(LogicaArreglo array, LogicaPozo logicaPozo, Jugador jugador) { // Cambiar parámetro Pozo por LogicaPozo
        this.array = array;
        this.logicaPozo = logicaPozo;
        ...
        if (recurso != null) {
            ...
            for (int i = 0; i < 8; i++) {
                ...
                boton.addActionListener(e -> {
                    Ficha fichaNueva = logicaPozo.sacarFicha(); // Usar LogicaPozo en lugar de Pozo
                    if (fichaNueva != null) {
